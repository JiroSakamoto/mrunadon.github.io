...
本編放送前のデータが入ってしまっていることもあって、このゼロの影響はちょっと取り除いて考えたい。

また、これらの検索ワードによる検索は、悲しいかなコンスタントに生起しない事象のようです。

そうなると、「検索があった時」にどれくらい注目を集めていたのかが気になるところですね。

ここからは、「検索があるかないか」を考えた上で、「検索があった時」に　どの程度注目が集まったのか考えることができる、ゼロ過剰ポアソン分布で人気度を推定していきたいと思います。具体的には、「検索があった日」に、平均的にどの程度の人気度があったのかを、ポワソン分布の平均パラメータの推定で求めていきます。
...
ゼロ過剰ポワソン推定結果
<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plot.ly/~JiroSakamoto/9.embed"></iframe>
